...
export default function Programcilar() {
  ...
  const [oneCikanId, setOneÇikanİd] = useState(null);
  ...
  const oneCikaninIsmi = () => {
    ...
    const öneÇikanProgramci = programcilar.find((dev) => dev.id === oneCikanId);
    return öneÇikanProgramci.isim;
  };
